...
var HTMLlinkin = '<li class="flex-item"><span class="orange-text">linkedin</span><span class="white-text">%data%</span></li>';
...
function that will need this helper code to run. Don't delete!
