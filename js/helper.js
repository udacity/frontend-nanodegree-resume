...
var HTMLskillsStart = '<h3 id="skillsH3" class="text-center">Skills at a Glance</h3><ul id="skills" class="flex-box"></ul>';
...
var HTMLprojectImage = '<img class="project-img" src="%data%"> </div>';
