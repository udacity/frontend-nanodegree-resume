...
var HTMLmobile = '<li class="flex-item"><span class="orange-text">cell</span><span class="white-text">%data%</span></li>';
var HTMLemail = '<li class="flex-item"><span class="orange-text">email</span><a href="%href%"><span class="white-text">%data%</span></a></li>';
var HTMLtwitter = '<li class="flex-item"><span class="orange-text">twitter</span><span class="white-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github</span><a href="%href%"><span class="white-text">%data%</span></a></li>';
...
var HTMLprojectImage ='<a href="%href%"' +
                        '<picture>' +
                            ...
                            '<source media="(min-width: 600px)"' +
                                    'srcset="%med%">' +
                           '<img class="project-img" src="%small%">' +
                         '</picture>' +
                       '</a>';
